...
const starter_deck_promptCards = [
...
const green_deck_promptCards = [
  ...
  "I may not be much to look at, but I fuck like ____________.",
  ...
  "She's just one of the guys, you know? She likes beer, and football, and ____________.",
...
// Starter Deck Responses
const starter_deck_responseCards = [
...
const blue_deck_responseCards = [
  ...
  "Snorting code off a clown's boner.",
...
// Green Deck Responses
const green_deck_responseCards = [
  ...
  "Overthrowing the democatically-elected goverment of Chile.",
  ...
  "Just now finding out about Armenian Genocide.",
  ...
  "Regurgitatin a half-digested sparrow.",
...
const bigger_blacker_box_responseCards = [
  "Pandora's vagina.",
  "A box.",
  ...
  "A box-shaped man.",
  "A man-shaped box.",
  "A cop with a weird pecker."
];

promptCards = [...starter_deck_promptCards, ...red_deck_promptCards, ...blue_deck_promptCards, ...green_deck_promptCards];
responseCards = [...starter_deck_responseCards, ...red_deck_responseCards, ...blue_deck_responseCards, ...green_deck_responseCards, ...bigger_blacker_box_responseCards];
